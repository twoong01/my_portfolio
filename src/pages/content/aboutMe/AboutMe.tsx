            ...
            <RightWrap ref={scrollRef}>
              <MyMind>
                ...
                <MyMindTxt>
                  ...
                  주의 깊게 고려하는 것이 중요하다고 생각합니다.
                  <br />
                  그래서 <BoldUnderLineTxt>역지사지 마음가짐</BoldUnderLineTxt>
                  을 가지고, 항상 사용자의 관점에서 생각하며 개선하려고 노력하고
                  있습니다.
                </MyMindTxt>

                <SubTit>소통은 중요한 요소.</SubTit>
                <MyMindTxt>
                  협업은 성공적인 프로젝트를 위해 중요한 요소라고 생각합니다.
                  <br />
                  <BoldUnderLineTxt>
                    팀원들과의 원활한 커뮤니케이션과 피드백
                  </BoldUnderLineTxt>
                  을 통해 구체화 하고 지속적으로 개선하고 싶습니다.
                </MyMindTxt>
              </MyMind>
